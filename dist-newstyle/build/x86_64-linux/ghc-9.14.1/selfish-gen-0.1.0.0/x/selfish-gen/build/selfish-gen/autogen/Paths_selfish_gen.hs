...
-- at runtime using the environment variable selfish_gen_bindir.
...
-- environment variable selfish_gen_libdir.
...
-- using the environment variable selfish_gen_dynlibdir.
...
-- runtime using the environment variable selfish_gen_datadir.
...
-- variable selfish_gen_libexedir.
...
-- using the environment variable selfish_gen_sysconfdir.
...
bindir     = "/home/alisa_unix/.cabal/bin"
libdir     = "/home/alisa_unix/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/selfish-gen-0.1.0.0-inplace-selfish-gen"
dynlibdir  = "/home/alisa_unix/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/alisa_unix/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/selfish-gen-0.1.0.0"
libexecdir = "/home/alisa_unix/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/selfish-gen-0.1.0.0"
sysconfdir = "/home/alisa_unix/.cabal/etc"

getBinDir     = catchIO (getEnv "selfish_gen_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "selfish_gen_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "selfish_gen_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "selfish_gen_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "selfish_gen_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "selfish_gen_sysconfdir") (\_ -> return sysconfdir)
